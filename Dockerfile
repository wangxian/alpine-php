...
# install packages
RUN apk add --update libpng freetype libjpeg libwebp \
    && apk add --update --no-cache --virtual .build-deps $PHPIZE_DEPS curl-dev openssl-dev pcre-dev pcre2-dev zlib-dev \
